...
class AppScreens extends Base {
    ...
    onChangeScreen(btn: HTMLDivElement, id: string) {

        let navBtns = this.querySelectorAll(".btn-screen-switch");
    ...
    render() {
        ...
        if (metaDiariaItems.length === 0) {
            ...
            swapScreen("screenHomeCaloriaDiaria");
        ...
        render(this, html`
            <style>
                ...
                <div class="screen close" id="screenHomeRegistroAlimentos">
...
<!--  https://www.svgrepo.com/collection/solar-outline-icons/10 -->
            ...
            <div>
                <div class="btn-screen-switch" id="screenHomeCardapioNav" onclick=${(e) => this.onChangeScreen(e.currentTarget, "screenHomeCardapio")}>
                ...
                <div class="btn-screen-switch open" id="screenHomeRegistroAlimentosNav" onclick=${(e) => this.onChangeScreen(e.currentTarget, "screenHomeRegistroAlimentos")}>
                <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="btn-screen-switch" id="screenHomeCalculadoraNav" onclick=${(e) => this.onChangeScreen(e.currentTarget, "screenHomeCalculadora")}>
                    <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="btn-screen-switch" id="screenHomeCaloriaDiariaNav" onclick=${(e) => this.onChangeScreen(e.currentTarget, "screenHomeCaloriaDiaria")}>     
